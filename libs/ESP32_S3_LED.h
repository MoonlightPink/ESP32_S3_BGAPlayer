...
static void ESP32_S3_LED_SetRGB(int r, int g, int b) {
	...
	if (b < 0x00) { b = 0x00; }
	if (0xff < b) { b = 0xff; }
	ESP32_S3_LED_Strip.setPixelColor(0, ESP32_S3_LED_Strip.Color(r, g, b));
	ESP32_S3_LED_Strip.show();
}

static void ESP32_S3_LED_SetBlack() { ESP32_S3_LED_SetRGB(0x00, 0x00, 0x00); }
static void ESP32_S3_LED_SetRed() { ESP32_S3_LED_SetRGB(0xff, 0x00, 0x00); }
static void ESP32_S3_LED_SetGreen() { ESP32_S3_LED_SetRGB(0x00, 0xff, 0x00); }
static void ESP32_S3_LED_SetBlue() { ESP32_S3_LED_SetRGB(0x00, 0x00, 0xff); }
